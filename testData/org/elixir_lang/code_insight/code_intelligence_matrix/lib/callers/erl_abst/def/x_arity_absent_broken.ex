...
defmodule Callers.ErlAbst.Def.XArityAbsentBroken do
  import :erl_abst_def_x_arity_absent

  def at_no_arguments(_a, _b), do: :erl_abst_def_x_arity_absent.erl_abst_def_x_arity_absent_snoc # @no_arguments
  ...
  def at_kernel_name(a, _b), do: :erl_abst_def_x_arity_absent.is_nil(a) # @kernel_name
end
