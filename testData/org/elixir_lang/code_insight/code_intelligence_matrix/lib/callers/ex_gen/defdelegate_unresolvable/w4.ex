...
defmodule Callers.ExGen.DefdelegateUnresolvable.W4 do
  alias ExGen.DefdelegateUnresolvable.W4
  alias ExGen.DefdelegateUnresolvable.W4, as: Aliased
  import ExGen.DefdelegateUnresolvable.W4

  def at_qualified(a, b), do: ExGen.DefdelegateUnresolvable.W4.ex_gen_defdelegate_unresolvable_w4_snoc(a, b) # @qualified
  def at_aliased(a, b), do: W4.ex_gen_defdelegate_unresolvable_w4_snoc(a, b) # @aliased
  def at_aliased_as(a, b), do: Aliased.ex_gen_defdelegate_unresolvable_w4_snoc(a, b) # @aliased_as
  ...
  def at_lookalike_xsnoc(a, b), do: ExGen.DefdelegateUnresolvable.W4.ex_gen_defdelegate_unresolvable_w4_xsnoc(a, b) # @lookalike_xsnoc
  def at_lookalike_snoc_x(a, b), do: ExGen.DefdelegateUnresolvable.W4.ex_gen_defdelegate_unresolvable_w4_snoc_x(a, b) # @lookalike_snoc_x
