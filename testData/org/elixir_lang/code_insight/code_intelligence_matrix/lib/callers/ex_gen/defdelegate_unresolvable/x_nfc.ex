...
defmodule Callers.ExGen.DefdelegateUnresolvable.XNfc do
  ...
  def at_qualified(a, b), do: ExGen.DefdelegateUnresolvable.XNfc.ex_gen_defdelegate_unresolvable_x_nfc_snoć(a, b) # @qualified
