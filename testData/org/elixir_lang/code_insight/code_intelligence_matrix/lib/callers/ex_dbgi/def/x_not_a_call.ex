...
defmodule Callers.ExDbgi.Def.XNotACall do
  alias ExDbgi.Def.XNotACall
  alias ExDbgi.Def.XNotACall, as: Aliased
  import ExDbgi.Def.XNotACall

  def at_qualified(a, b), do: ExDbgi.Def.XNotACall.ex_dbgi_def_x_not_a_call_snoc(a, b) # @qualified
  def at_aliased(a, b), do: XNotACall.ex_dbgi_def_x_not_a_call_snoc(a, b) # @aliased
  def at_aliased_as(a, b), do: Aliased.ex_dbgi_def_x_not_a_call_snoc(a, b) # @aliased_as
